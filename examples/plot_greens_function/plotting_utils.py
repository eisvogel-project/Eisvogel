...
def plot_field(ax, data, range_x, range_y, xlabel = "r [m]", ylabel = "z [m]", epilog = None, fs = 13, vmin = 0.0, vmax = 2e-3, linthresh = 1e-5):
    ...
    # cmap = cmr.get_sub_cmap('cmr.ember', 0.1, 1.0)
    cmap = "bwr"
